...
themeBuildingPrimitives, overrides) {
  ...
  const {
    primaryFontFamily,
    ...colors
  } = themeBuildingPrimitives; // color keys in the themeBuildingPrimitives are the same as
  // the colorTokens so we just extend it with overrides
  // passed as an argument

  const colorTokensWithOverrides = { ...colorTokens,
    ...colors
  };
  const theme = {
    colors: { ...colorTokensWithOverrides,
