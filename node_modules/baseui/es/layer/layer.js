...
class LayerComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    const host = this.props.host !== undefined ? this.props.host : document.body;
  ...
  render() {
    ...
    const childrenToRender = zIndex ? React.createElement(Container, {
      $zIndex: zIndex
    }, children) : children;
...
export default function Layer(props) {
  return React.createElement(Consumer, null, ({
    host,
    zIndex
  }) => React.createElement(LayerComponent, _extends({}, props, {
    host: host,
    zIndex: zIndex
  })));
}