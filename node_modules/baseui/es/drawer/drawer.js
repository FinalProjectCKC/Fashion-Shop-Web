...
import { StyledRoot, StyledBackdrop, StyledDrawerContainer, StyledDrawerBody, StyledClose } from './styled-components.js';
    ...
    return React.createElement(LocaleContext.Consumer, null, locale => {
      return (// eslint-disable-next-line jsx-a11y/no-autofocus
        React.createElement(FocusLock, {
          ...
          "aria-label": "drawer"
        }, sharedProps, drawerContainerProps), React.createElement(DrawerBody, _extends({}, sharedProps, drawerBodyProps), children), closeable ? React.createElement(Close, _extends({
