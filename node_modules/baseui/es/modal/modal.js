...
class Modal extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "onDialogContainerBackdropClick", e => {
      if (e.target instanceof HTMLElement && e.target.contains(this.getRef('DialogContainer').current)) {
  ...
  renderModal() {
    ...
    if (this.props.autofocus === false && process.env.NODE_ENV !== "production") {
    ...
    return React.createElement(LocaleContext.Consumer, null, locale => React.createElement(FocusLock, {
      returnFocus: true // eslint-disable-next-line jsx-a11y/no-autofocus
      ,
      autoFocus: this.props.autofocus !== null ? this.props.autofocus : this.props.autoFocus
