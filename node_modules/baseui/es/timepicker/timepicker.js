...
function stringToOptions(str, format = '12') {
...
class TimePicker extends React.Component {
  ...
  buildSelectedOption(value, format = '12') {
  ...
  render() {
    ...
    const value = this.props.value instanceof Date ? this.buildSelectedOption(this.props.value, this.props.format) : this.state.value;
    return React.createElement(LocaleContext.Consumer, null, locale => React.createElement(OverriddenSelect, _extends({
