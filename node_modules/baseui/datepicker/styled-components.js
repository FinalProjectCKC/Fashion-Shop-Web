...
var StyledRoot = (0, _index.styled)('div', function (props) {
  ...
  return _objectSpread2({}, typography.font200, {
...
function getDayStyles(code, _ref5) {
  ...
  var dayStateStyle = _objectSpread2({}, generateDayStyles('001000000000000', {
...
var StyledDay = (0, _index.styled)('div', function (props) {
  ...
  return _objectSpread2({
    ...
    ':first-child': _objectSpread2({}, $range ? {
      ':before': _objectSpread2({}, getEdgeDayBeforeStyle(code, true, $peekNextMonth))
    } : {}),
    ':last-child': _objectSpread2({}, $range ? {
      ':before': _objectSpread2({}, getEdgeDayBeforeStyle(code, false, $peekNextMonth))
    } : {})
  });
});
