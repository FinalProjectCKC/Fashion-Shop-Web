...
var RadioGroupRoot = (0, _index.styled)('div', function (props) {
  var $disabled = props.$disabled,
      $align = props.$align;
  return {
    display: 'flex',
...
var Description = (0, _index.styled)('div', function (props) {
  ...
  return _objectSpread2({}, props.$theme.typography.font200, (_objectSpread4 = {
    color: props.$theme.colors.contentSecondary,
    cursor: 'auto'
  }, _defineProperty(_objectSpread4, props.$theme.direction === 'rtl' ? 'marginRight' : 'marginLeft', props.$theme.sizing.scale900), _defineProperty(_objectSpread4, "maxWidth", '240px'), _objectSpread4));
});
