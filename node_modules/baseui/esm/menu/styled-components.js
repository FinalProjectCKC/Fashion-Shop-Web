...
export var StyledEmptyState = styled('li', function (props) {
  var $theme = props.$theme,
      $size = props.$size;
  return _objectSpread2({}, $size === OPTION_LIST_SIZE.compact ? $theme.typography.font100 : $theme.typography.font200, {
    position: 'relative',
    display: 'block',
...
export var StyledListItem = React.forwardRef(function (_ref2, ref) {
  var item = _ref2.item,
