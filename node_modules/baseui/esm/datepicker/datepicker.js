...
import { formatDate as _formatDate } from './utils/index.js';
  ...
  function Datepicker() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleInputChange", function (event) {
      ...
      if (_this.props.range) {
        ...
        isValid(startDate) && isValid(endDate) && isAfter(endDate, startDate) && _this.props.onChange && _this.props.onChange({
