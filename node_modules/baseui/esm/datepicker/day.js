...
function (_React$Component) {
  ...
  _createClass(Day, [{
    ...
    value: function getAriaLabel(sharedProps, localeContext) {
      ...
      return "".concat(sharedProps.$selected ? sharedProps.$range ? sharedProps.$startDate ? localeContext.datepicker.selectedStartDateLabel : localeContext.datepicker.selectedEndDateLabel : localeContext.datepicker.selectedLabel : sharedProps.$disabled ? localeContext.datepicker.dateNotAvailableLabel : localeContext.datepicker.chooseLabel, " ").concat(formatDate(date, 'EEEE, MMMM do yyyy', locale), ". ").concat(!sharedProps.$disabled ? localeContext.datepicker.dateAvailableLabel : '');
    }
  }, {
    key: "render",
