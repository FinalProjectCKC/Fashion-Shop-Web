  ...
  _createClass(Popover, [{
    ...
    value: function renderPopover() {
      ...
      return React.createElement(Body, _extends({
        ...
        key: "popover-arrow",
        ref: this.arrowRef
      }, sharedProps, getOverrideProps(ArrowOverride))) : null, React.createElement(Inner, _extends({
        key: "popover-inner"
      }, sharedProps, getOverrideProps(InnerOverride)), typeof content === 'function' ? content() : content));
    }
  }, {
    key: "render",
